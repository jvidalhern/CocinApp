    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adaptadorPedidosActivos = new AdaptadorPedidosActivos(VerHistoricoPedidosActivity.this, R.layout.pedidos_historicos_vista) {
            ...
            public void onEntrada(Pedido pedidoActivo, View view) {
                ...
                // Cambiar color fondo
                filaPedidoColor.setBackgroundColor(getResources().getColor(R.color.semi_transparente));
                textViewComentarios.setBackgroundColor(getResources().getColor(R.color.semi_transparente));
